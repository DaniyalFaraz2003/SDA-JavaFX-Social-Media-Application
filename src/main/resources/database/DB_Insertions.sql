...
INSERT INTO Answer (post_id, student_id, marked_correct, votes, text, time_stamp) VALUES
    ...
    (9, 10, FALSE, 7, 'Use .bodyValue(request) to send a JSON payload in the body of the POST request. The WebClient will automatically convert the Java object (YourRequestType) into a JSON string if you have Jackson or Gson initializePost up in your classpath.', NOW()),
