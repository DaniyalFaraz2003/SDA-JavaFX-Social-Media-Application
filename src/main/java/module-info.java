module com.example.sdaprojectsocialmediaapp {
    ...
    opens com.example.sdaprojectsocialmediaapp.controllers.chat to javafx.fxml;
    opens com.example.sdaprojectsocialmediaapp.controllers.notification to javafx.fxml;
