...
public class RegisterCont {
    ...
    void register(MouseEvent event) throws IOException {
        Student student = new Student(i_firstName.getText(), i_lastName.getText(), i_username.getText(), i_password.getText(), i_email.getText(), i_address.getText(), i_phone.getText());
